"""2026-08-06 周四001-005 — Dixon-Coles fit from de-juiced fair (禁嘴算).
...
TICAI_LINE = {                      # 体彩让球线(主队 + line 口径,3 路)
    "周四001": -1, "周四002": 1, "周四003": 1, "周四004": -1, "周四005": -2,
}
MATCH = {
    "周四001": ("M-2026-08-06-维多利亚-巴竞技", "维多利亚 vs 巴竞技(巴西杯16强次回合)"),
    "周四002": ("M-2026-08-06-库奥皮奥-克拉约瓦", "库奥皮奥 vs 克拉约瓦(欧联Q3首回合)"),
    "周四003": ("M-2026-08-06-比亚韦-流浪者", "比亚韦斯托克 vs 流浪者(欧联Q3首回合)"),
    "周四004": ("M-2026-08-06-塞萨洛-安德莱", "PAOK vs 安德莱赫特(欧联Q3首回合)"),
    "周四005": ("M-2026-08-06-本菲卡-哈茨", "本菲卡 vs 哈茨(欧联Q3首回合)"),
}
