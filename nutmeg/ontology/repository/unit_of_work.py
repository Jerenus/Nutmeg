...
if TYPE_CHECKING:
    ...
    from nutmeg.ontology.repository.replay import HistoricalReplayRepository
...
class OntologyUnitOfWork:
    ...
    @property
    def replay(self) -> HistoricalReplayRepository:
        from nutmeg.ontology.repository.replay import HistoricalReplayRepository

        return HistoricalReplayRepository(self.connection)
