...
from nutmeg.services.psychology.schemas import DashboardRow, DataLeg, DualSchemeReport, FinalLeg, FinalScheme, GuardrailDecision, Scheme

def _report() -> DualSchemeReport:
    return DualSchemeReport(Scheme("data", [DataLeg("L1","f1","HHAD","home_win",2.1)]), Scheme("psychology", [DataLeg("L1","f1","HHAD","away_win",2.45)]), FinalScheme([FinalLeg("L1","f1","HHAD","away_win",2.45,"psychology")], "medium", []), [DashboardRow("f1","home_win","away_win",True,"away_win",0.8)], None, GuardrailDecision([], [], {"budget":"1/1"}))
